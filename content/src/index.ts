...
import { deepClients } from './clients-deep';
...
import { randomEvents, randomEventsDeep } from './random-events';
...
/** 全量题库（廿一批合计） */
export const examBankAll = [...examBank, ...examBank2, ...examBank3, ...examBank4, ...examBank5, ...examBank6, ...examBank7, ...examBank8, ...examBank9, ...examBank10, ...examBank11, ...examBank12, ...examBank13, ...examBank14, ...examBank15, ...examBank16, ...examBank17, ...examBank18, ...examBank19, ...examBank20, ...examBank21];

/** 知识库全量（七批合计） */
const debriefAll = [...DEBRIEF_CARDS, ...debriefCardsDeep];

export const KNOWLEDGE_ALL = [...KNOWLEDGE, ...knowledgeBatch2, ...knowledgeBatch3, ...knowledgeBatch4, ...knowledgeBatch5, ...knowledgeBatch6, ...knowledgeBatch7];
...
const clientsAll = [...clients, ...deepClients];
...
export { factors, industries, releases, directorEvents, products, clients, deepClients, eraDrift, eraLevel, examBank, examBank2, KNOWLEDGE, randomEvents, randomEventsDeep, VOLUME1_QUESTS, VOLUME1_LIFELINES, VOLUME2_QUESTS, VOLUME3_QUESTS, VOLUME4_QUESTS, VOLUME5_QUESTS, WANG_LIFELINE, LI_LIFELINE };
