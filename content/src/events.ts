...
export const directorEvents: GameEventDef[] = [
  ...
  // ===== 第五轮深化批 10 条（2008 开门降息/2010 通胀顶/2012 刚兑信仰/2014 沪港通/2016 债灾前夜/2018 民企违约/2019 包商信用分层/2020 LPR 新机制/2021 共同富裕/2023 五篇大文章；小冲击、无 force_day、锚点安全；其中 5 条对应 knowledge11 复盘卡 eventRef） =====
  { id: 'dir_2008_open_cut', date: '2008-10-09', type: 'policy', title: '四万亿前夜：降息降准双管齐下', news: '救市组合拳落地，降息与降准并行，市场在最低迷处收到"托底"信号，债市率先转牛。', shocks: { lpr_5y: -0.008, rate10y: -0.003, liquidity: 0.03, equity: 0.01 }, duration_days: 5, sentiment: 0.6, unlock_knowledge: ['policy_stimulus'] },
  { id: 'dir_2010_inflwave', date: '2010-09-15', type: 'macro', title: '通胀预期升温：理财抢购潮', news: 'CPI 连续高位，负利率引发居民抢购"比存款高"的理财与黄金，网点单月销量冲高，通胀见顶前夜情绪最浓。', shocks: { equity: -0.02, gold: 0.02, rate10y: 0.002 }, duration_days: 8, sentiment: -0.6, unlock_knowledge: ['k_infl_2010_household'] },
  { id: 'dir_2012_trust', date: '2012-09-10', type: 'macro', title: '信托刚兑信仰的顶点', news: '"刚性兑付"成为行业默契，非标与信托产品收益率层层加码，客户把"历史刚兑"当成"未来保证"，信仰在顶点最牢固。', shocks: { credit: 0.003, liquidity: -0.015, equity: -0.01 }, duration_days: 6, sentiment: -0.4, unlock_knowledge: ['k_shadow_banking'] },
  { id: 'dir_2014_hgt', date: '2014-12-02', type: 'policy', title: '沪港通首批成交放量', news: '互联互通开通后首波资金持续流入大金融与消费白马，"外资审美"首次重塑 A 股权重定价，蓝筹重估行情启动。', shocks: { equity: 0.02, style_big: 0.025 }, duration_days: 6, sentiment: 0.8, unlock_knowledge: ['k_hsgt_2014_first'] },
  { id: 'dir_2016_bond', date: '2016-04-15', type: 'macro', title: '债市"债灾"前夜', news: '通胀预期升温叠加资金面收紧，债券收益率快速上行，"稳健"理财开始浮亏，久期风险浮出水面。', shocks: { rate10y: 0.003, equity: -0.008 }, duration_days: 6, sentiment: -0.5, unlock_knowledge: ['duration'] },
  { id: 'dir_2018_csd', date: '2018-05-25', type: 'macro', title: '民企债券违约潮', news: '去杠杆背景下民企信用利差走阔，债券违约集中暴露，"机构信仰"开始为信用分层定价，理财底层资产质量成为焦点。', shocks: { credit: 0.004, equity: -0.015 }, duration_days: 8, sentiment: -0.8, unlock_knowledge: ['credit'] },
  { id: 'dir_2019_bonds', date: '2019-05-24', type: 'macro', title: '包商接管：同业刚兑信仰被打破', news: '某城商行因严重信用风险被接管，处置打破"同业必兑付"惯例，同业存单利差分化，理财与债市第一次认真定价"机构信用"。', shocks: { credit: 0.003, liquidity: -0.02, equity: -0.01 }, duration_days: 5, sentiment: -0.7, unlock_knowledge: ['k_credit_spread'] },
  { id: 'dir_2020_lpr', date: '2020-04-20', type: 'policy', title: 'LPR 新机制：房贷定价全面切换', news: '存量房贷定价由 LPR 加点重新定价，客户集中来问"我的利率会不会降"，利率传导进入微观体感时代。', shocks: { lpr_5y: -0.002, rate10y: -0.001 }, duration_days: 4, sentiment: 0.3, unlock_knowledge: ['lpr'] },
  { id: 'dir_2021_common', date: '2021-08-17', type: 'policy', title: '共同富裕座谈：政策风险定价课', news: '共同富裕研究定调，行业盈利模型与社会外部性被重估，"政策敏感行业"估值体系重构，成为抱团瓦解的重要背景。', shocks: { equity: -0.018, style_small: -0.02, style_big: 0.01 }, duration_days: 5, sentiment: -0.6, unlock_knowledge: ['k_policy_stimulus'] },
  { id: 'dir_2023_finc18', date: '2023-10-30', type: 'policy', title: '中央金融工作会议：五篇大文章', news: '科技/绿色/普惠/养老/数字金融"五篇大文章"定调，资源配置向新质生产力倾斜，养老金融与科技金融成为网点产品与考核高频词。', shocks: { equity: 0.012, style_big: 0.015, sentiment_dom: 0.2 }, duration_days: 5, sentiment: 0.6, unlock_knowledge: ['k_nfra_era'] },
];
