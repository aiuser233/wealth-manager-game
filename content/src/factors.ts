...
export const factors: MarketFactorDef[] = [
  ...
  { id: 'us_equity', name: '美股（纳指）', layer: 'global', start: 2200, sigma_daily: 0.0095, drift_pa: 0.075, mean_revert: 0, unit: 'index' },
  ...
  { id: 'gold', name: '黄金', layer: 'global', start: 540, sigma_daily: 0.008, drift_pa: 0.07, mean_revert: 0, unit: 'index' },
  { id: 'risk_g', name: '全球风险情绪', layer: 'global', start: 100, sigma_daily: 0.012, mean_revert: 0.002, anchor: 100, unit: 'index' },
  // ===== 国内层 =====
  { id: 'equity', name: 'A 股整体', layer: 'domestic', start: 1160, sigma_daily: 0.011, drift_pa: 0.055, mean_revert: 0, unit: 'index' },
  { id: 'style_big', name: '大盘/价值风格', layer: 'domestic', start: 1000, sigma_daily: 0.009, drift_pa: 0.05, mean_revert: 0, unit: 'index' },
  { id: 'style_small', name: '小盘/成长风格', layer: 'domestic', start: 1000, sigma_daily: 0.013, drift_pa: 0.06, mean_revert: 0, unit: 'index' },
  ...
  { id: 'housing', name: '房价指数', layer: 'domestic', start: 100, sigma_daily: 0.0015, drift_pa: 0.075, mean_revert: 0, unit: 'index' },
