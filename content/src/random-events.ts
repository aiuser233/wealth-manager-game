...
export const randomEventsDeep4: RandomEventDef[] = [
  // ===== 第四轮深化批 10 条（理财转存潮/智能手机课堂/代发流失/压岁钱账户/降额潮/停电应急/贵金属兑付/自购潮/社保转移/数字遗产） =====
  { id: 're_rollover_wave', title: '理财到期转存潮', era: [2015, 2025], weight: 2,
    text: '一批理财产品集中到期，客户排队来转存，都是"到期就锁定长周期高息"的口径。',
    effects: {},
    choices: [
      { text: '按家庭现金流分层处理：活期垫+短梯+长梯，拒绝一刀切锁长', outcome: '客户按分层方案办理，半年后要急用钱的客户感激你留了活口。', effects: { trust: 2 }, teach: 'deposit_migration' },
      { text: '顺势都办长周期产品，任务好完成', outcome: '利率下行后客户想动钱发现全是长期锁定，投诉与不满并存。', effects: { stress: 1 } },
    ],
    teach: '转存潮是现金流规划的入口，不是冲任务的窗口。',
  },
  { id: 're_senior_phone_class', title: '老年智能手机课堂', era: [2018, 2025], weight: 2,
    text: '网点办"手机课堂"，来了二十多位老人，问题从查余额一路问到"视频里的专家说这只票要翻倍"。',
    effects: {},
    choices: [
      { text: '课程收尾专门加十分钟反诈环节，用真实案例拆"专家荐股"', outcome: '一位老人当场删除了荐股群，家属特意来道谢。', effects: { trust: 2, fame: 1 }, teach: 'k_anti_fraud_call' },
      { text: '按课件讲完就散会', outcome: '两周后社区传来消息：有学员被"专家群"骗走了三万。', effects: { fame: -1 } },
    ],
    teach: '适老课堂的教学重点不是功能，是防坑。',
  },
  { id: 're_payroll_outflow', title: '代发工资户的流失', era: [2010, 2025], weight: 2,
    text: '一家代发企业刚换合作行，员工工资到账即转走，你看着流水一天天空转。',
    effects: {},
    choices: [
      { text: '上门做一次员工专属权益宣讲：代发优惠+工资卡理财+信用卡', outcome: '三成员工留下资金沉淀，企业方也记住了你这家"会服务的银行"。', effects: { aum: 300000, fame: 1 }, teach: 'payroll' },
      { text: '「工资卡嘛，能用就行」', outcome: '半年后这家企业的代发批量转移到新合作行。', effects: {} },
    ],
    teach: '代发户的价值靠服务挖潜，不是靠默认留存。',
  },
  { id: 're_kids_account', title: '压岁钱开户大军', era: [2012, 2025], weight: 2,
    text: '年后网点来了排队开少儿账户的家长，问题集中在"存定期还是买教育金"。',
    effects: {},
    choices: [
      { text: '讲压岁钱三笔法：储蓄打底+教育金定投+让孩子管一小笔学决策', outcome: '家长当场开了三个口袋，还说要带孩子来听"第一堂财商课"。', effects: { trust: 1, fame: 1 }, teach: 'education_fund' },
      { text: '都推荐利率最高的定期', outcome: '客户办完就走，教育金需求被隔壁行的"少儿成长账户"接走了。', effects: {} },
    ],
    teach: '压岁钱是财商教育的入口，别只当存款营销。',
  },
  { id: 're_card_limit', title: '信用卡降额潮', era: [2019, 2025], weight: 1,
    text: '银行收紧信用卡授信，多位客户被降额，柜台前情绪激动："我又没逾期！"',
    effects: {},
    choices: [
      { text: '解释授信动态调整机制，帮优质客户提供恢复额度的合规路径', outcome: '客户虽然不满但理解了机制，两位客户还顺带做了负债结构梳理。', effects: { trust: 1 }, teach: 'credit' },
      { text: '「行里的事，我也没办法」', outcome: '三位客户把怨气写进了投诉工单，全部点名你。', effects: { fame: -1, stress: 1 } },
    ],
    teach: '降额不可控，解释方式可控。',
  },
  { id: 're_blackout', title: '网点突发停电', era: [2006, 2025], weight: 1,
    text: '营业中突然停电，叫号机黑屏、柜台系统切换应急电源，大堂开始骚动。',
    effects: {},
    choices: [
      { text: '启动应急分工：安抚疏导+手工登记+优先老弱，恢复后逐一补办', outcome: '一小时恢复后无投诉，支行通报表扬"应急演练练到位"。', effects: { fame: 1, stress: 1 }, teach: 'systemic_risk' },
      { text: '等电力恢复再说', outcome: '四十五分钟的混乱里两位老人被挤到，营业结束后投诉直达分行。', effects: { fame: -2 } },
    ],
    teach: '停电十分钟的秩序，值过去一个月的营销。',
  },
  { id: 're_gold_delivery', title: '实物金条兑付高峰', era: [2011, 2025], weight: 1,
    text: '金价高位，客户集中要求实物金条提货，库房告急，"下周才有货"的说法点燃了柜台情绪。',
    effects: {},
    choices: [
      { text: '给出替代方案：积存金份额+预约提货时间表+回购政策讲解', outcome: '多数客户接受积存金，提货预约排得明明白白，无人投诉。', effects: { trust: 1 }, teach: 'gold' },
      { text: '「没货就退货吧」', outcome: '三位客户退单转去金店，顺带把"银行服务不行"告诉了邻居。', effects: { aum: -100000 } },
    ],
    teach: '实物兑付管理的不是货，是预期。',
  },
  { id: 're_fund_selfbuy', title: '基金经理自购公告', era: [2015, 2025], weight: 1,
    text: '某基金经理公告自购百万跟投，客户群瞬间刷屏："经理都买了，我跟！"',
    effects: {},
    choices: [
      { text: '肯定自购的信号价值，同时讲清"跟投 ≠ 保赢"，落到仓位建议', outcome: '客户理性跟投了可承受的仓位，净值波动期没有恐慌来电。', effects: { trust: 1 }, teach: 'fund_selection' },
      { text: '「赶紧上车，过了这村没这店」', outcome: '基金回撤 20% 后，客户翻出你的聊天记录找你"算账"。', effects: { trust: -2 } },
    ],
    teach: '自购是信心信号，不是收益承诺。',
  },
  { id: 're_shebao_transfer', title: '异地社保转移咨询潮', era: [2010, 2025], weight: 2,
    text: '客户跳槽去外地工作，扎堆来问社保转移、公积金提取和代缴靠谱吗。',
    effects: {},
    choices: [
      { text: '整理官方转移流程一页纸，明确提醒"代缴挂靠"的法律风险', outcome: '一页纸被拍照转发，客户群体里你成了"办得了事"的人。', effects: { trust: 2, fame: 1 }, teach: 'consumer_protection' },
      { text: '「这个不归银行管」', outcome: '客户转头找了"代缴中介"，三个月后社保骗补被查，想起你当时没提醒。', effects: { trust: -1 } },
    ],
    teach: '不归银行管的事，提醒到位也是专业。',
  },
  { id: 're_digital_legacy', title: '数字遗产咨询', era: [2022, 2025], weight: 1,
    text: '客户悄悄问："万一我不在了，手机里的理财账户、虚拟币、游戏账号，家里人能拿到吗？"',
    effects: {},
    choices: [
      { text: '讲清数字资产的权属与平台规则差异，建议做数字遗产备忘录+法律工具兜底', outcome: '客户做了一份完整备忘录，还介绍了两位朋友来做家庭账户梳理。', effects: { trust: 2 }, teach: 'succession' },
      { text: '「想那么多干嘛，不吉利」', outcome: '客户讪讪离开，后来在别处被骗"代持数字资产"。', effects: {} },
    ],
    teach: '新形态资产的程序空白，正是专业服务的空白。',
  },
];

// ================= 第五轮深化批随机事件（10 条，2026-2027 近未来；纯文本层，不挂市场数值 shock） =================
export const randomEventsDeep5: RandomEventDef[] = [
  { id: 're_ai_deepfake', title: 'AI 数字分身诈骗', era: [2026, 2027], weight: 2,
    text: '一位客户来电"声音"一模一样，说要把账户资金转去"海外对冲"——其实是 AI 伪造的分身在试探他。',
    effects: {},
    choices: [
      { text: '挂断后用预留渠道核实，教客户设立"暗号+双向确认"的反深伪流程', outcome: '深伪诈骗没得逞，客户把你的防诈口诀记了满本。', effects: { trust: 3, fame: 1 }, teach: 'fraud_alert' },
      { text: '「您自己判断」，挂电话了事', outcome: '客户差点被深伪转走养老钱，投诉里写满了"银行教了我一句废话"。', effects: { trust: -3, stress: 2 } },
    ],
    teach: 'AI 时代，"确认对方是谁"成了新的反诈骗第一课。',
  },
  { id: 're_pension_draw', title: '个人养老金到期领取', era: [2026, 2027], weight: 2,
    text: '一批个人养老金账户满锁定期，客户来问"现在取出来合不合算"。',
    effects: {},
    choices: [
      { text: '按边际税率算领取税负，给"延迟/部分领取"三档方案', outcome: '客户选了最省税的一档，还把你推荐给了邻居。', effects: { trust: 2 }, teach: 'third_pillar' },
      { text: '「到期就取，早取早安心」', outcome: '他按最高税率缴了领取环节个税，事后找你算账。', effects: { trust: -1, stress: 1 } },
    ],
    teach: '养老金的税务账要算到"领取那一步"才算完。',
  },
  { id: 're_sub1pct', title: '存款利率跌破 1%', era: [2026, 2027], weight: 2,
    text: '一年期定存利率跌到 1% 以下，客户群里一片"钱没地方放"的焦虑。',
    effects: {},
    choices: [
      { text: '办"低利率时代四笔钱"工作坊：应急/短债/权益/保险的再平衡', outcome: '客户按新框架重排了资产，存款焦虑变成了配置行动。', effects: { trust: 2, aum: 80000 }, teach: 'rate10y' },
      { text: '「大家都降，没办法」', outcome: '客户把钱搬去了"高息"的私募，你错过了教育窗口。', effects: { stress: 1 } },
    ],
    teach: '利率下行期，客户要的是方案，不是安慰。',
  },
  { id: 're_cbt2', title: '跨境理财通二阶段', era: [2026, 2027], weight: 1,
    text: '跨境理财通扩容到更多城市，客户问"额度怎么用才不亏在汇率上"。',
    effects: {},
    choices: [
      { text: '讲清资金闭环规则 + 分批换汇 + 汇率对冲工具，做成一页纸', outcome: '客户按汇率情景做了分批，避险意识上了一个台阶。', effects: { trust: 2 }, teach: 'fx_risk' },
      { text: '「汇率看跌涨都行，买就完了」', outcome: '汇率回撤时客户把你这句当成"你让我买"的证据。', effects: { stress: 2 } },
    ],
    teach: '跨境通道的红利，要配得上汇率对冲的基本功。',
  },
  { id: 're_rebuy_ebb', title: '换房潮退坡', era: [2026, 2027], weight: 1,
    text: '以旧换新政策退坡，客户纠结"现在换房还是再等等"，等你拍板。',
    effects: {},
    choices: [
      { text: '只给框架：杠杆/流动性/机会成本三变量，自住需求与投资需求分开算', outcome: '两位客户一个果断换、一个坚定等，都没把决定推给你。', effects: { trust: 1 }, teach: 'housing_vs_invest' },
      { text: '「政策要退了，快买」', outcome: '他高位接了二手房，半年后开始后悔，你的"快买"被截图。', effects: { trust: -1, stress: 1 } },
    ],
    teach: '不替客户做决定，是理财经理最体面的克制。',
  },
  { id: 're_retire_peak', title: '退休潮首高峰', era: [2026, 2027], weight: 2,
    text: '首批"75 后"集中退休，养老规划咨询排到了两周后。',
    effects: {},
    choices: [
      { text: '开"退休资金流沙盘"：把养老金/储蓄/房产拆成现金流曲线', outcome: '客户第一次看清退休后的钱"从哪来、花到哪"，方案当场落地。', effects: { trust: 2, fame: 1 }, teach: 'retirement_plan' },
      { text: '推一款"养老理财"就走', outcome: '产品卖了，客户的退休现金流缺口没人管。', effects: { stress: 1 } },
    ],
    teach: '退休潮的入口是现金流规划，不是卖产品。',
  },
  { id: 're_robot_lobby', title: '机器人进厅堂', era: [2026, 2027], weight: 1,
    text: '网点上了智能机器人大堂经理，同事担心"真人服务没戏了"，客户好奇围观。',
    effects: {},
    choices: [
      { text: '把机器人用于分流取号，自己专注复杂咨询与情感陪伴', outcome: '客户记住了"那个愿意陪我讲半小时的经理"，口碑反而更高了。', effects: { trust: 2, fame: 1 }, teach: 'ai_advisor' },
      { text: '和机器人抢活干，对客户说"机器不懂"砸场子', outcome: '把工具当对手，你被时代淘汰得更快。', effects: { stress: 2 } },
    ],
    teach: '机器人接流程，人接信任——定位错了才会慌。',
  },
  { id: 're_lowalt_open', title: '低空经济开户热', era: [2026, 2027], weight: 1,
    text: '低空经济概念又热，客户追着问"要不要现在冲进去"。',
    effects: {},
    choices: [
      { text: '讲主题板块的高波动与政策周期，建议定投+仓位上限而非追涨', outcome: '客户按纪律分批参与，行情回撤时心态稳。', effects: { trust: 1 }, teach: 'industry_cycle' },
      { text: '「风口来了，闭眼上车」', outcome: '主题退潮后客户高位站岗，你的"风口论"被翻出来。', effects: { trust: -2, stress: 2 } },
    ],
    teach: '主题越热，仓位纪律越要冷。',
  },
  { id: 're_dcep_payroll', title: '数字货币工资代发', era: [2026, 2027], weight: 1,
    text: '某企业试点数字货币工资代发，员工问"数字钱包里的钱怎么理财"。',
    effects: {},
    choices: [
      { text: '讲清数字钱包与理财账户的边界，规划工资自动分层归集', outcome: '员工工资到账即分层，你的服务从"办卡"升级成"现金流管家"。', effects: { trust: 1, fame: 1 }, teach: 'cash_mgmt' },
      { text: '「先存着，以后再说」', outcome: '资金堆在钱包里沉睡，机会成本全算在了"没服务"上。', effects: {} },
    ],
    teach: '新支付形态的钱，同样需要被"管起来"。',
  },
  { id: 're_wealth_transfer', title: '代际财富转移咨询潮', era: [2026, 2027], weight: 2,
    text: '一波"二代"来问"父辈的资产怎么合法合规地接过来"，传承需求集中爆发。',
    effects: {},
    choices: [
      { text: '做传承全景：股权/不动产/保险/信托的隔离与税务路径，分场景给方案', outcome: '一个家族三条线排得明明白白，客户转介绍了整个家族。', effects: { trust: 3, aum: 200000 }, teach: 'succession' },
      { text: '「过户去公证处就行」', outcome: '客户带着问题去了别家私行，你只留下了半句敷衍。', effects: { trust: -2 } },
    ],
    teach: '代际转移是财富管理最复杂也最值钱的一块拼图。',
  },
];
