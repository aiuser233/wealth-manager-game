...
> **公测当前口径（2026-09-17）**：题库源记录 5089，经内容指纹去重后公测唯一题 3841 / 知识词条 276 / 复盘卡 45 / 导演事件 140 / 随机事件 115 / 产品 63 / 客户 37 / 人生线 13 条 109 节点 / 接待需求 27 / 成就 30。主线全库 90 章，卷七二周目线与卷八一周目线互斥注册，因此单周目为 82 章。题→词引用 100%，词→题仅剩 7 个零引用 tag。下表中的长清单保留各批次来源，本行是唯一的当前数量口径。
...
### 3.4 题库（51 批 5089 条源记录 / 3841 道公测唯一题，题→词 100% + 词→题反向缝合）
...
- **序列化**：`serializeNow()`（v3 存档，字段清单见 §6；兼容旧版 v2 读档并在读档前生成备份）。
...
**内容量**（公测收口后）：题库源记录 5089 / 公测唯一题 3841 / 词条 276 / 主线全库 90 章（单周目 82）/ 人生线 13 条 109 节点 / 复盘卡 45 / 导演事件 140 / 产品 63 / 客户 37 / 随机事件 115 / 行动小剧场 60 / 接待需求 27 / 考试科目 8 / 成就 30。**双向缝合**：公测池完整重复 0、题→词 100%，276 词条仅 7 个零引用；双审元数据 4097/4117，状态仍为 draft，发布培训包前需补齐 20 条 review 并完成人工双审。
