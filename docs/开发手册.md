...
### 3.4 题库（35 批 4289 题，全库题-词缝合 100%）
...
| `DossierPanel.vue` | 生涯档案页（C1.1）：careerLog 按卷号分七卷时间线（卷七·二周目来客：标题含"记忆残响/来客"归卷七）（gradeLabel 徽章：best ✦/good ✓/normal ○/bad ✗）、八维生涯卡片（职级/AUM/主线 x/82/人生线节点/信任均值/违规/最佳抉择率/证书）、Avatar+成就 chip、**HTML 导出（自包含 CSS，打印即 PDF）** |
...
82 个主线任务中 50 个挂 `requires` 字段，构成跨卷叙事链（q1_04→…→q1_12→q2_01→…→q5_12→卷六彩蛋 e9~e14 链→卷七记忆残响 q7_1→…→q7_8 链）：后置任务即使日期到期，若前置未完成也不触发（玩家补做前置后下次帧推进即触发）。链路覆盖：卷一 8 条承接链、卷二 5 条、卷三 4 条、卷四 3 条、卷五 3 条 + 卷间衔接 4 条 + 卷二/卷三各 1 条 + 卷六 14 章链 + 卷七 8 章链。`ref-check` 校验 requires 必须指向真实任务 id，防手滑断链。
...
**内容量**（第四轮深化批后）：题库 4289 / 词条 251 / 主线 82 章（五卷各 12 + 卷六彩蛋 14 + 卷七·二周目来客 8，NG+ 专属）/ 人生线 12 条 101 节点 / 复盘卡 40 / 导演事件 130 / 产品货架 58 / 客户 36 / 随机事件 105 / 行动小剧场 60 场景 / 接待需求 24 种 / 考试科目 8 / 成就 29 枚；**题-词缝合：全库 4289 题 100% 命中词条体系——R4 将 exams28-35 前存量的 260 题 58 个野 tag 经 repair-tags.py 人工映射清零，ref-check 升级为全库孤儿题红线（>0 即红灯）**；双审元数据 4520/4540 条（status=draft 待人工审校——**发布培训包前必须人工审完翻 approved**，这是当前唯一硬性欠账，见规划合并文档 §15）。
