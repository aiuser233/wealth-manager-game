...
| `lifelines.ts` | **5 条人生线 44 节点**：王秀兰 9（养老客群）、李建国 9（工薪客群）、周宏图 9（企业主）、吴建国 8（大众客群）、何志敏 9（年轻客群：定投启蒙→职场从众→兄长飞单案修复→转岗合规→AI 合规官→带出徒弟） | `LifeLineDef`：year/month/client/title/text/trustReq 信任门槛/effects；信任达标自动触发演出 |
...
**内容量**：题库 989 / 词条 147 / 任务 60 / 人生线 44 节点 / 复盘卡 18 / 导演事件 81 / 产品 32 / 客户 10 / 随机事件 36；双审元数据 1116/1136 条（status=draft 待人工审校——**发布培训包前必须人工审完翻 approved**，这是当前唯一硬性欠账，见规划合并文档 §15）。
