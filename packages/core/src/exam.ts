...
export const EXAM_DEFS: ExamDef[] = [
  ...
  // 两门专项在完整去重后各有 10 道唯一题；公测期按唯一库存组卷，避免同卷重复。
  { id: 'exam_insurance', name: '银行保险·寿险与银保业务（题库 Beta）', pass_mark: 0.6, question_count: [10, 10], time_limit_sec: 600, unlock_year: 2010, desc: '银保渠道实务：保障规划、销售适当性与双录规范。专项题库仍在审校扩充。' },
  { id: 'exam_fund_alloc', name: '基金从业·资产配置专项（题库 Beta）', pass_mark: 0.7, question_count: [10, 10], time_limit_sec: 600, unlock_year: 2013, desc: '进阶专项：核心卫星、再平衡纪律与风险预算。专项题库仍在审校扩充。' },
];
