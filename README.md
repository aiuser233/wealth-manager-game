...
> **正式考说明**：题库 2689 题当前均为 draft 待人工双审，正式考暂不可用（日志会提示），练习/模考不受影响；培训后台可开「开发模式」放行全部题目。
...
| 维度 | 现状 |
|---|---|
| 阶段 | P1–P6 全部完成（P6 美术音频明确跳过）+ C1.1 增强批次 + 首次试运行修复批 8 项 + 试运行二批 6 项 + **口碑经营体验批（stats/转介绍/流失召回/预约/档案馆/错题重练/设置/年报）** + **深化扩充批（题库 1689→2089 八科目/客户 22/小剧场 41/随机事件 60/词条 165/复盘卡 24/导演事件 93/接待需求 14）** + **第二轮深化扩充批（题库 2089→2689 六批新格式/客户 30/小剧场 60/随机事件 80/词条 195/复盘卡 30/导演事件 105/接待需求 18/产品 47/人生线 77/主线 68 含卷六彩蛋 8）**，详见[规划合并文档 §14](docs/项目总体规划与实施状态.md) |
| 质量 | 五管线全绿：typecheck / vitest 88 / build 1.03MB / sim 锚定 / bot 数值 |
| 内容量 | **题库 2689（8 科目）+示范题包 3 · 词条 195 · 主线 68 章（34 条跨卷前置链，含卷六彩蛋 8）· 人生线 9 条 77 节点 · 复盘卡 30（日历视图）· 导演事件 105 · 产品货架 47 · 客户 30 · 随机事件 80 · 行动小剧场 60 场景 · 接待需求 18** |
