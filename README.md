...
| 维度 | 现状 |
|---|---|
| 阶段 | P1–P6 全部完成（P6 美术音频明确跳过），详见[规划合并文档](docs/项目总体规划与实施状态.md) |
| 质量 | 五管线全绿：typecheck / vitest 88 / build 731.6kB / sim 锚定 / bot 数值 |
| 内容量 | 题库 1089 · 词条 147 · 主线 60 任务 · 人生线 6 条 52 节点 · 复盘卡 18 · 导演事件 81 |
| B 端 | 培训后台（学员记录/聚合报表/行内题包/讲师大屏 28 幕）就绪，试点未开始 |
