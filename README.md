...
> **正式考说明**：题库 4289 题当前均为 draft 待人工双审，正式考暂不可用（日志会提示），练习/模考不受影响；培训后台可开「开发模式」放行全部题目。
...
| 维度 | 现状 |
|---|---|
| 阶段 | P1–P6 全部完成（P6 美术音频明确跳过）+ C1.1 增强批次 + 首次试运行修复批 8 项 + 试运行二批 6 项 + **口碑经营体验批（stats/转介绍/流失召回/预约/档案馆/错题重练/设置/年报）** + **深化扩充批（题库 1689→2089 八科目/客户 22/小剧场 41/随机事件 60/词条 165/复盘卡 24/导演事件 93/接待需求 14）** + **第二轮深化扩充批（题库 2089→2689/客户 30/词条 195/主线 68 含卷六彩蛋 8）** + **第三轮深化扩充批（题库 2689→3489 八批并实现题-词缝合 100%/词条 226/主线 74 含彩蛋 14/人生线 11 条 93 节点/导演事件 120/随机事件 95/复盘卡 35/需求 21/产品 53/客户 35）** + **第四轮深化扩充批（存量 260 题野 tag 缝合归零+全库孤儿题红线/题库 3489→4289 混合科目×场景化八批/词条 251/主线 82 含卷七·二周目来客 NG+ 8 章/人生线 12 条 101 节点（周薇线）/导演事件 130/随机事件 105/复盘卡 40/需求 24/产品 58/客户 36/成就 29）**，详见[规划合并文档 §14](docs/项目总体规划与实施状态.md) |
| 质量 | 五管线全绿：typecheck / vitest 88 / build 1.03MB / sim 锚定 / bot 数值 |
| 内容量 | **题库 4289（8 科目，全库题-词缝合 100%）+示范题包 3 · 词条 251 · 主线 82 章（50 条跨卷前置链，含卷六彩蛋 14+卷七 NG+ 8）· 人生线 12 条 101 节点 · 复盘卡 40（日历视图）· 导演事件 130 · 产品货架 58 · 客户 36 · 随机事件 105 · 行动小剧场 60 场景 · 接待需求 24 · 成就 29** |
