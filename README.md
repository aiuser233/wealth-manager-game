...
> **正式考说明**：公测题池已从 5089 条源记录去重为 **3841 道唯一题**，当前仍为 draft 待人工双审；正式考入口会标记“审校中”，练习/模考不受影响。
...
| `npm test` | Vitest 全量单测（108 个，11 文件） | 每次改代码后 |
| `npm run test:e2e` | Playwright 桌面+手机真实浏览器公测主路径 | 发布前 |
...
| 质量 | content:check / typecheck / Vitest 108 / build / sim / bot 全绿；Playwright 桌面+手机公测主路径 2 条全绿 |
| 内容量 | **题库源记录 5089、公测唯一题 3841（完整重复 0；8 科目，题→词 100%，词→题仅 7 个零引用）+示范题包 3 · 词条 276 · 主线全库 90 章（54 条 requires；单周目 82 章，卷七/卷八互斥）· 人生线 13 条 109 节点 · 复盘卡 45 · 导演事件 140 · 产品 63 · 客户 37 · 随机事件 115 · 行动小剧场 60 · 接待需求 27 · 成就 30** |
